      ...
      <div className="bg-slate-900 text-slate-300 text-xs border-b border-slate-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-2 flex flex-col sm:flex-row items-center justify-between gap-2">
          <div className="flex items-center space-x-3 text-[11px]">
            ...
            <span>&bull;</span>
            <span className="text-slate-400">Apex University &bull; Chartered 1965</span>
          ...
          <div className="flex items-center space-x-3 cursor-pointer" onClick={() => onNavigate('landing')}>
            ...
            <div>
              <div className="flex items-center space-x-2">
                <span className="font-bold text-xl font-serif text-slate-900 tracking-tight">Apex University</span>
      ...
      <footer className="bg-slate-900 text-slate-400 py-12 border-t border-slate-800 text-xs font-sans">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 pb-8 border-b border-slate-800">
            <div className="space-y-3">
              <div className="flex items-center space-x-2">
                ...
                <span className="font-bold text-white font-serif text-base">Apex University</span>
              </div>
              <p className="text-xs text-slate-400 leading-relaxed">
                Smart Campus Assistant & Autonomous Grievance Administration Framework &bull; Built for Academic Excellence.
              </p>
              <p className="text-[11px] text-slate-500">
                Apex Campus, Academic Ridge Road &bull; Pincode 600025
              </p>
            </div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 text-[11px] text-slate-500">
            <p>&copy; 2026 Apex University. All Rights Reserved &bull; Governed under University Statutes.</p>
